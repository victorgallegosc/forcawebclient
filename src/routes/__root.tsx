  ...
  head: () => ({
    meta: [
      ...
      { title: "Sunderland A3860 · Fin de Semana 2026" },
      {
        name: "description",
        content:
          "Tabla, calendario, goleo y turnos de aventón del A3860 Sunderland en el 3er Torneo Fin de Semana 2026.",
      },
      { name: "author", content: "A3860 Sunderland" },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="min-h-screen pitch-glow">
        <SiteNav />
